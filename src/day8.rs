...
fn main() {
    println!("Part 1: {}", part1("assets/day8/input.txt"));
    println!("Part 2: {}", part2("assets/day8/input.txt"));
}
...
mod tests {
    ...
    #[test]
    fn test_part1() {
        assert_eq!(part1("assets/day8/example.txt"), 14);
    }

    #[test]
    fn test_part2() {
        assert_eq!(part2("assets/day8/example.txt"), 34);
    }
}
