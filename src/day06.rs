...
fn main() {
    println!("Part 1: {}", part1("assets/day06/input.txt"));
    println!("Part 2: {}", part2("assets/day06/input.txt"));
}
...
mod tests {
    ...
    #[test]
    fn test_part1() {
        assert_eq!(part1("assets/day06/example.txt"), 41);
        assert_eq!(part1("assets/day06/input.txt"), 4967);
    }

    #[test]
    fn test_part2() {
        assert_eq!(part2("assets/day06/example.txt"), 6);
        assert_eq!(part2("assets/day06/input.txt"), 1789);
    }
}
